                ...
                {dataList.map(data => {
                    ...
                    return (
                        <a key={data.project_id} href={data.link_url} target="_blank">
                            <div className={`border-box border-2 border-two rounded-lg w-[300px] h-[350px] overflow-auto hover:shadow-two shadow-xl mr-3 transition duration-0 hover:duration-300 ease-in-out ${((data.project_id) > (window.innerWidth >= 640 ? 3 : 1)) ? 'mt-14 mb-6' : ''} `}>
